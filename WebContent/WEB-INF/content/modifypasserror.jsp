...
<html>  
   <head>              
        <meta http-equiv=refresh content=5;url="modifypass.jsp"> 
        <title>错误</title>
        <style type="text/css">
        a:hover{
        color:#FF4500;
      ...
      <%--  <%=request.getContextPath()%>  --%>
        <div align="center">  
            <h3 style=color:red>抱歉！你的账户不存在</h3>  
            <h3 style=color:red><span id=jump>5</span> 秒钟后页面将发回到当前页面......</h3>  
        ...
        <script>  
            ...
            function jumpToILoginin(){  
                window.location.href='modifypass.jsp';  
            }  
       </script>  
</html>