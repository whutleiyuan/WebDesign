...
<body>
	<div class="home">
		...
		<a href="##"> <i class="iconfont-left icon-zhineng1" style="font-size:30px;"></i>
		 <span>经过智能小安的检测，本次操作需要您通过以下方式确认身份</span>
		</a>
		</div>
		
		<form action="modifypass" method="post" >
		<div class="container">
		<span id="one">请输入你的密码：</span>
		<div class="row">
			<div class="form-group ">				
				<div class="col-sm-3">
				<input type="text"class="form-control" name="password" id="textUserName" placeholder="用户密码" autofocus="" required="true" />
			</div>
			</div>
			</div>
			<br>
			<input type="submit" class="btn col-sm-1" value="确认"  onclick="modifypass()">
			<br>		
		</div>
		</form>
